/**
 * To create dots for the carousel
 * @param {HTMLElement} slides Array of slides present in carousel
 * @returns {HTMLElement} Document fragment of dots created
 */
...
const dotsContainer = createDots(slides).children[0];
